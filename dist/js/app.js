    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelectorAll(".swiper")) {
                new swiper_core_Swiper(".welcome__slider", {
                    ...
                    pagination: {
                        ...
                        renderBullet: function(index, className) {
                            let slideNumber = index + 1 <= 9 ? `0${index + 1}` : `${index + 1}`;
                    ...
                    on: {
                        init: function() {
                            ...
                            bullets.forEach(((bullet, index) => {
                                if (index === this.realIndex) bullet.innerHTML = index + 1 <= 9 ? `0${index + 1}` : `${index + 1}`; else bullet.innerHTML = "•";
                            }));
                        },
                ...
                new swiper_core_Swiper(".tesmontials__slider", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                    ...
                    on: {
                        init: function() {
                            let bullets = document.querySelectorAll(".tesmontials-pagination .swiper-pagination-bullet");
                            bullets.forEach(((bullet, index) => {
                                if (index === this.realIndex) bullet.innerHTML = index + 1 <= 9 ? `0${index + 1}` : `${index + 1}`; else bullet.innerHTML = "•";
                            }));
                        },
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                } else console.log("Ой ой, немає такого підменю :(");
                e.preventDefault();
            }
